...
public class RecyclerviewAdapter4 extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof RecyclerviewAdapter4.ViewHolderHead) {
            ...
            ((RecyclerviewAdapter4.ViewHolderHead) holder).textView11.setText(movielist.get(position).getTitle());
            ...
            Glide.with(context).load(movielist.get(position * 2).getImg()).into(((RecyclerviewAdapter4.ViewHolder) holder).imageView11);
